...
process = cms.Process("WMuNuPATSelector")
...
process.MessageLogger = cms.Service("MessageLogger",
    debugModules = cms.untracked.vstring('wMuNuPATSelector'),
...
process.wMuNuPATSelector = cms.EDFilter("WMuNuPATSelector",
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('WMuNuPATSelector.root') )

process.p = cms.Path(process.wMuNuPATSelector)
